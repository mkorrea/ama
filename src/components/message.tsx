  ...
  return (
    <li data-answered={answered} className="ml-4 leading-relaxed text-zinc-100 data-[answered=true]:opacity-50 data-[answered=true]:pointer-events-none">
      ...
      {hasReacted ? (
        <button 
          type="button" 
          className="mt-3 flex items-center gap-3 text-orange-400 text-sm font-medium hover:text-orange-500"
        >
        ...
        <button 
          type="button" 
          className="mt-3 flex items-center gap-3 text-zinc-400 text-sm font-medium hover:text-zinc-300"
